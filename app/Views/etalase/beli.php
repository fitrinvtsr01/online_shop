...
<div class="container">
    <div class="row">
        <div class="col-6">
            <div class="card-body">
                <img src="<?= base_url('uploads/' . $model->gambar) ?>" alt="" class="img-fluid" width="300px">
        ...
        <div class="col-6">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="kabupaten">
                    <option value="">Select Provinsi/Kota</option>
                </select>
            </div>
            <div class="form-group">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <a href="<?= site_url('Komentar/create/' . $model->id) ?>" class="btn btn-link">Silahkan Komentar disini</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
